...
define(function(require,exports,module){
	...
	function bindEvent(){
		...
		$("#update").on("click",function(){
			...
			require.async('custom',function(){
				$.ajax({    
					url: contextPath+'/providersResource/updateBooking.do',       
					type:'post',    
					cache:false,  			
					dataType:'json', 
					data:{
				    ...
				    success: function (data) {
				    	if(data.result=='0'){
				    		$("#page-inner iframe",window.parent.document).attr("src",contextPath+"/providersResource/bookingList.do?providersId="+$("#providersId").val());
				    	}else{
	...
	function updateImageId(){
		$.ajax({    
			...
			cache:false,  			
			dataType:'json', 
			data:{id:$("#bookingId").val(),imageId:-1},
		    success: function (data) {
