...
define(function(require,exports,module){
	...
	function bindEvent(){
		...
		$("#update").on("click",function(){
			...
			require.async('custom',function(){
				$.ajax({    
					url: contextPath+'/providersResource/updateQualification.do',       
					type:'post',    
					cache:false,  			
					dataType:'json', 
					data:{
						id:$("#qualificationId").val(),
						title:$("#title").val(),
				    ...
				    success: function (data) {
				    	if(data.result=='0'){
				    		$("#page-inner iframe",window.parent.document).attr("src",contextPath+"/providersResource/qualificationList.do?providersId="+$("#providersId").val());
				    	}else{
	...
	function updateImageId(){
		$.ajax({    
			...
			cache:false,  			
			dataType:'json', 
			data:{id:$("#qualificationId").val(),imageId:-1},
		    success: function (data) {
