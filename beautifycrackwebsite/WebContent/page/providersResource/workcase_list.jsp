...
<div class="pt10 pl10">
	<button id="addWorkcase" type="button" class="btn btn-primary">新增</button>
</div>
...
<script type="text/javascript">
	seajs.use("sea-modules/providersResource/workcase_list",function(module){module.init();});
</script>
</html>