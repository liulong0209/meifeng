...
<body>
	<ol class="breadcrumb">
	  <li><a href="${contextPath}/productCompanymanager.do">材料/工具提供公司管理</a></li>
    ...
    <script type="text/javascript">
		seajs.use("sea-modules/productCompany/productCompany_edit",function(module){module.init()})
	</script>
</html>